...
resource "aws_vpc" "main" { 
    ...
    tags = {
        Name = "Table19-UseCase4-vpc-main-${random_id.vpc_display_id.hex}"
    }
}
# ------------------------------------------------------
# SUBNETS
...
resource "aws_subnet" "public_subnets" {
    ...
    tags = {
        Name = "Table19-UseCase4--public-subnet-${count.index}-${random_id.vpc_display_id.hex}"
    }
}
# ------------------------------------------------------
# IGW
...
resource "aws_internet_gateway" "igw" { 
    vpc_id = aws_vpc.main.id
    tags = {
        Name = "Table19-UseCase4-igw-${random_id.vpc_display_id.hex}"
    }
}
# ------------------------------------------------------
# ROUTE TABLE
...
resource "aws_route_table" "route_table" {
    ...
    tags = {
        Name = "Table19-UseCase4-route-table-${random_id.vpc_display_id.hex}"
    }
}
...
resource "aws_instance" "postgres_customers" {
    ...
    tags = {
        Name = "Table19-UseCase4-postgres-customers-instance-${random_id.customers_id[count.index].hex}"
    }
}
# ------------------------------------------------------
# CUSTOMERS EIP
...
resource "aws_eip" "postgres_customers_eip" {
    ...
    tags = {
        Name = "Table19-UseCase4-postgres-customers-eip-${random_id.customers_id[count.index].hex}"
    }
}
# ------------------------------------------------------
...
resource "aws_instance" "postgres_products" {
    ...
    tags = {
        Name = "Table19-UseCase4-postgres-products-instance-${random_id.products_id[count.index].hex}"
    }
}
# ------------------------------------------------------
# PRODUCTS EIP
...
resource "aws_eip" "postgres_products_eip" {
    ...
    tags = {
        Name = "Table19-UseCase4-postgres-products-eip-${random_id.products_id[count.index].hex}"
    }
}
